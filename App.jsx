...
import FishingManiaProductScreen from './src/screens/FishingManiaProductScreen';
...
const App = () => {
  ...
  OneSignal.initialize('37eb5bcd-ef11-468c-a9d6-30cb01e91b6c');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-03-24T10:00:00'); //дата з якої поч працювати webView
                  ...
                  return (
                        <Stack.Navigator>
                              <Stack.Screen
                                    ...
                                    name="FishingManiaProductScreen"
                                    component={FishingManiaProductScreen}
